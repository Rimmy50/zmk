 ...
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_gpio_50000000[] = { DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, 8, 18, DEVICE_HANDLE_ENDS };
...
/* 14 : /behaviors/behavior_transparent:
 * Direct Dependencies:
 *   - (/behaviors)
 * Supported:
 *   - (/keymap/first_layer)
...
/* 16 : /behaviors/behavior_bluetooth:
 * Direct Dependencies:
 *   - (/behaviors)
 * Supported:
 *   - (/keymap/second_layer)
